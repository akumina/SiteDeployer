...
We have switched to using GitHub releases for easier management, please see the [release section](https://github.com/akumina/SiteDeployer/releases) for downloading the Site Deployer assets
